...
namespace Devinno.Skia.Dialogs
{
    public class DvKeyboard : DvWindow
    {
        ...
        public int LabelTextSize { get; set; } = 14;
        public int ButtonTextSize { get; set; } = 14;
        ...
        public DvKeyboard()
        {
            ...
            gpnl.Rows.Add(new DvGridRow(DvSizeMode.Percent, 15 ));
            gpnl.Rows.Add(new DvGridRow(DvSizeMode.Percent, 17 ));
            gpnl.Rows.Add(new DvGridRow(DvSizeMode.Percent, 17 ));
            gpnl.Rows.Add(new DvGridRow(DvSizeMode.Percent, 17 ));
            gpnl.Rows.Add(new DvGridRow(DvSizeMode.Percent, 17 ));
            gpnl.Rows.Add(new DvGridRow(DvSizeMode.Percent, 17 ));
            ...
            for (int i = 0; i < 10; i++) gpnl.Rows[1].Columns.Add(new SizeInfo(DvSizeMode.Percent, 10));
            for (int i = 0; i < 10; i++) gpnl.Rows[2].Columns.Add(new SizeInfo(DvSizeMode.Percent, 10));
            for (int i = 0; i < 10; i++) gpnl.Rows[3].Columns.Add(new SizeInfo(DvSizeMode.Percent, i == 0 ? 5 : 10));
            for (int i = 0; i < 9; i++) gpnl.Rows[4].Columns.Add(new SizeInfo(DvSizeMode.Percent, (i == 0 || i == 8 ? 15 : 10)));

            gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 15));
            gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 10));
            gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 10));
            gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 40));
            gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 10));
            gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 15));
            ...
            for (int i = 0; i < 10; i++) Ns[i] = new DvButton() { Name = "Ns" + (i + 1), FontSize = ButtonTextSize, IconSize = ButtonIconSize, Gradient = ButtonGradient };
            for (int i = 0; i < 10; i++) Us[i] = new DvButton() { Name = "Us" + (i + 1), FontSize = ButtonTextSize, IconSize = ButtonIconSize, Gradient = ButtonGradient };
            for (int i = 0; i < 9; i++) Ms[i] = new DvButton() { Name = "Ms" + (i + 1), FontSize = ButtonTextSize, IconSize = ButtonIconSize, Gradient = ButtonGradient };
            for (int i = 0; i < 7; i++) Ds[i] = new DvButton() { Name = "Ds" + (i + 1), FontSize = ButtonTextSize, IconSize = ButtonIconSize, Gradient = ButtonGradient };
            for (int i = 0; i < 3; i++) Ss[i] = new DvButton() { Name = "Ss" + (i + 1), FontSize = ButtonTextSize, IconSize = ButtonIconSize, Gradient = ButtonGradient };
            Ent = new DvButton() { Name = nameof(Ent), Text = "", FontSize = ButtonTextSize, IconString = "", IconSize = ButtonIconSize, Gradient = ButtonGradient };
            Back = new DvButton() { Name = nameof(Back), Text = "", FontSize = ButtonTextSize, IconString = "", IconSize = ButtonIconSize, Gradient = ButtonGradient };
            Clear = new DvButton() { Name = nameof(Clear), Text = "", FontSize = ButtonTextSize, IconString = "", IconSize = ButtonIconSize, Gradient = ButtonGradient };
            Han = new DvToggleButton() { Name = nameof(Han), Text = "", FontSize = ButtonTextSize, IconString = "", IconSize = ButtonIconSize, Gradient = ButtonGradient };
            Num = new DvToggleButton() { Name = nameof(Num), Text = "", FontSize = ButtonTextSize, IconString = "", IconSize = ButtonIconSize, Gradient = ButtonGradient };
            Shift = new DvToggleButton() { Name = nameof(Shift), Text = "", FontSize = ButtonTextSize, IconString = "", IconSize = ButtonIconSize, Gradient = ButtonGradient };
        ...
        void SetButtonText()
        {
            ...
            Ent.IconString = "mt keyboard_return";
        ...
        void show(string Title, Action actLayout, Action actOK)
        {
            ...
            foreach (var c in gpnl.Controls.Values)
            {
                ...
                else if (c is DvLabel)
                {
                    var vc = c as DvLabel;
                    vc.FontSize = ButtonTextSize;
                    vc.IconSize = ButtonIconSize;
                }
                else if (c is DvToggleButton)
                {
        ...
        {
            this.Width = DialogWidth ?? 640;
            this.Height = DialogWidth ?? 400;
            ...
            show(Title, () =>
            {
                ...
                {
                    gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 20));
                    gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 60));
                    gpnl.Rows[5].Columns.Add(new SizeInfo(DvSizeMode.Percent, 20));
                }
                #endregion
                #region Control
