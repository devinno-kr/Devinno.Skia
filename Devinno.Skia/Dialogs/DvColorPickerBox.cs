...
namespace Devinno.Skia.Dialogs
{
    public class DvColorPickerBox : DvWindow
    {
        ...
        DvControl color, hue;
        DvLabel lbl;
        DvNumberValueInput<int> inR, inG, inB;
        DvButton btnOK;
        DvButton btnCancel;
        ...
        public DvColorPickerBox()
        {
            ...
            tpnl.Columns.Add(new DvTableColumn() { Mode = SizeMode.Pixel, Size = 256 + 3 });
            tpnl.Columns.Add(new DvTableColumn() { Mode = SizeMode.Pixel, Size = 10 });
            tpnl.Columns.Add(new DvTableColumn() { Mode = SizeMode.Pixel, Size = 20 });
            tpnl.Columns.Add(new DvTableColumn() { Mode = SizeMode.Pixel, Size = 10 });
            tpnl.Columns.Add(new DvTableColumn() { Mode = SizeMode.Pixel, Size = 100 });
            ...
            inR = new DvNumberValueInput<int> { Name = nameof(inR), Title = "R", Minimum = 0, Maximum = 255, TitleWidth = 30 };
            inG = new DvNumberValueInput<int> { Name = nameof(inG), Title = "G", Minimum = 0, Maximum = 255, TitleWidth = 30 };
            inB = new DvNumberValueInput<int> { Name = nameof(inB), Title = "B", Minimum = 0, Maximum = 255, TitleWidth = 30 };
