...
namespace Devinno.Skia.Controls
{
    public abstract class DvValueInput : DvControl
    {
        ...
        protected override void OnDraw(SKCanvas Canvas)
        {
            bounds((rtContent, rtTitle, rtValueAll, rtUnit, rtValue) =>
            {
                ...
                if (ds != null && thm != null)
                {
                    ...
                    var BorderColor = this.BorderColor ?? thm.GetBorderColor(ValueBoxColor, ParentContainer.GetBackColor());
                    ...
                    using (var p = new SKPaint() { IsAntialias = DvDesign.AA })
                    {
                        ...
                        if (BackgroundDraw)
                        {
                            ...
                            thm.DrawBox(Canvas, rtValueAll, ValueBoxColor, BorderColor, RoundType.Round_R, BoxStyle.Border | BoxStyle.Fill | BoxStyle.OutBevel);
                        }

                        Util.DrawTextIcon(Canvas, Title + (!BackgroundDraw ? " : " : ""), FontName, FontSize, DvFontStyle.Normal, IconGap, TitleIconString, IconSize, ForeColor, rtTitle, IconAlignment, (!BackgroundDraw ? DvContentAlignment.MiddleRight : DvContentAlignment.MiddleCenter), true);
                        
                        DrawValue(Canvas, rtContent, rtTitle, rtValueAll, rtUnit, rtValue);
        ...
        protected override void OnMouseDown(int x, int y)
        {
            bounds((rtContent, rtTitle, rtValueAll, rtUnit, rtValue) =>
            {
                ...
                if (ds != null && thm != null)
                {
                    ...
                    {
                        MouseEV(rtContent, rtTitle, rtValueAll, rtUnit, rtValue, x, y);
                    }
                }
            });
        ...
        protected abstract void MouseEV(SKRect rtContent, SKRect rtTitle, SKRect rtValueAll, SKRect rtUnit, SKRect rtValue, int x, int y);
        protected abstract void DrawValue(SKCanvas Canvas, SKRect rtContent, SKRect rtTitle, SKRect rtValueAll, SKRect rtUnit, SKRect rtValue);
        #endregion
        #region Method
        #region bounds
    ...
    public class DvTextValueInput : DvValueInput
    {
        #region Properties
        ...
        protected override void MouseEV(SKRect rtContent, SKRect rtTitle, SKRect rtValueAll, SKRect rtUnit, SKRect rtValue, int x, int y)
        {
        ...
        #endregion
        #region DrawValue
        protected override void DrawValue(SKCanvas Canvas, SKRect rtContent, SKRect rtTitle, SKRect rtValueAll, SKRect rtUnit, SKRect rtValue)
        {
    ...
    public class DvNumberValueInput<T> : DvValueInput where T : struct
    {
        #region Constructor
        public DvNumberValueInput()
        {
    ...
    public class DvHexValueInput : DvValueInput
    {
        #region Properties
    ...
    public class DvBoolValueInput : DvValueInput
    {
    ...
    public class DvSelectorValueInput : DvValueInput
    {
        #region Member Variable
        bool bExpand = false;
        #endregion
