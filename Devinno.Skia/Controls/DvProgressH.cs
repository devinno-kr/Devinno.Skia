                ...
                bounds((rtContent, rtEmpty, rtFill) =>
                {
                    ...
                    if (ds != null && thm != null)
                    {
                        ...
                        using (var p = new SKPaint() { IsAntialias = DvDesign.AA  })
                        {
                            ...
                            if (rtFill.Width > 0)
                                thm.DrawBox(Canvas, rtFill, BarColor, BorderColor, RoundType.Round, BoxStyle.Border | BoxStyle.OutShadow | BoxStyle.InBevel | BoxStyle.GradientV);
                            ...
                            {
                                {
                                    ...
                                    if (rtFill.Width > 0)
                                    {
                                        ...
                                        Util.DrawText(Canvas, s, FontName, FontSize, DvFontStyle.Normal, ForeColor, rt, DvContentAlignment.MiddleLeft);
