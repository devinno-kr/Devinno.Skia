...
{
    public class DvRadioBox : Design.DvControl
    {
        #region Properties
        #region Text
        ...
        protected override void OnDraw(SKCanvas Canvas)
        {
            Areas((rtContent, rtArea) =>
            {
                ...
                if (ds != null && thm != null)
                {
                    ...
                    thm.DrawRadioBox(Canvas, rtContent, BoxSize, BoxColor, BorderColor, CheckColor, ForeColor, Text, FontName, FontSize, FontStyle, ContentAlignment, Checked);
                }
            });
            base.OnDraw(Canvas);
        }
