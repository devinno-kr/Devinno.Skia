...
namespace Devinno.Skia.Design
{
    public class DvDesign
    {
        ...
        internal DvKeypad Keypad { get; private set; }
        internal DvKeyboard Keyboard { get; private set; }
        internal DvSelectorBox SelectorBox { get; private set; }
        internal DvColorPickerBox ColorPickerBox { get; private set; }
        internal DvDateTimePickerBox DateTimePickerBox { get; private set; }
        #endregion
        ...
        #region public int MouseX { get; private set; }
        [JsonIgnore]
        public int MouseX { get; private set; }
        #endregion
        #region public int MouseY { get; private set; }
        [JsonIgnore]
        public int MouseY { get; private set; }
        #endregion
        #region public int MouseDownX { get; private set; }
        [JsonIgnore]
        public int MouseDownX { get; private set; }
        #endregion
        #region public int MouseDownY { get; private set; }
        [JsonIgnore]
        public int MouseDownY { get; private set; }
        #endregion

        #region public DvPage CurrentPage { get; set; }
        [JsonIgnore]
        ...
        public DvDesign()
        {
            ...
            SelectorBox = new DvSelectorBox();
            ColorPickerBox = new DvColorPickerBox();
            DateTimePickerBox = new DvDateTimePickerBox();
        }
        #endregion
        ...
        public void Draw(SKCanvas Canvas)
        {
            ...
            if(dragItem != null)
            {
                ...
                rt.Offset(5, 10);
                Util.DrawIconFA(Canvas, "fa-hand-pointer", 24, Theme.ForeColor, rt);
            }
            #endregion
        }
        #endregion
