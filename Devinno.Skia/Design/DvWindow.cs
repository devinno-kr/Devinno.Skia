...
namespace Devinno.Skia.Design
{
    public class DvWindow : IDvContainer
    {
        ...
        public SKImage BackgroundImage { get; set; } = null;
        ...
        public int IconBoxWidth { get; set; } = 40;
                        ...
                        bounds((rtExit, rtTitle, rtTitleBar, rtContent, rtIcon) =>
                        {
                            ...
                            using (var p = new SKPaint())
                            {
                                ...
                                if (BackgroundDraw)
                                {
                                    ...
                                    {
                                        cv.DrawImage(BackgroundImage, Util.FromRect(0, 0, Width, Height));
                                    }
                                    else
                                    {
                                        cv.Clear(BackColor);
                                ...
                                if (UseTitleBar)
                                {
                                    ...
                                    Util.DrawIconFA(cv, IconString, IconSize, ForeColor, rtIcon, DvContentAlignment.MiddleCenter);
