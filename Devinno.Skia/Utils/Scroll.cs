...
namespace Devinno.Skia.Utils
{
    public class Scroll
    {
        ...
        #endregion
        #region MouseDown
        public void MouseDown(int x, int y, SKRect rtScroll)
        {
        ...
        #endregion
        #region MouseMove
        public void MouseMove(int x, int y, SKRect rtScroll)
        {
            if (scDown != null)
            {
                if (Direction == ScrollDirection.Vertical)
        ...
        #region MouseDownR
        public void MouseDownR(int x, int y, SKRect rtScroll)
        {
        ...
        #endregion
        #region MouseMoveR
        public void MouseMoveR(int x, int y, SKRect rtScroll)
        {
            if (scDown != null)
            {
                if (Direction == ScrollDirection.Vertical)
