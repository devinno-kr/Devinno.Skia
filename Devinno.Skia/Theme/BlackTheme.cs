...
namespace Devinno.Skia.Theme
{
    public class BlackTheme : DvTheme
    {
        ...
        public override SKColor ScrollCursorOnColor => SKColors.Red;
        ...
        public override byte OutShadowAlpha => 40;
        public override byte OutBevelAlpha => 20;
        public override byte InShadowAlpha => 120;
        public override float GradientLight => 0.2F;
        public override float GradientDark => -0.2F;
        public override float DownBrightness => -0.25F;
        public override float BorderBrightness => -0.35F;
        #endregion
            ...
            bool bOpen, bool reverse, bool backgroundDraw)
        {
            ...
            var round = bOpen ? (reverse ? DvRoundType.B : DvRoundType.T) : DvRoundType.All;
            if (rnd == DvRoundType.Rect) round = DvRoundType.Rect;
            else if(rnd == DvRoundType.L) round = bOpen ? (reverse ? DvRoundType.LB : DvRoundType.LT) : DvRoundType.L;
            else if (rnd == DvRoundType.R) round = bOpen ? (reverse ? DvRoundType.RB : DvRoundType.RT) : DvRoundType.R;
            #endregion
